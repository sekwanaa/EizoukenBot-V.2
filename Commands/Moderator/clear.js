...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption((option) =>
      option.setName("amount").setDescription("Choose how many messages to delete").setRequired(true)
    )
    .addUserOption((option) =>
      option.setName("target").setDescription("Choose a specific person to delete messages for").setRequired(false)
    ),
